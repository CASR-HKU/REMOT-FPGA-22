...
#
# full_proj.tcl: Tcl script for re-creating project 'full_proj'
#
# Generated by Vivado on Fri Dec 10 20:23:04 HKT 2021
...
#
# 1. This project restoration tcl script (full_proj.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/yzgao/workspace/event_camera/au/REMOT/hardware/hls/pynq_new/full_final/full_proj/solution1/impl/ip/full_proj/full_proj.srcs/sources_1/imports/ip/design_1_wrapper.v"
#
...
proc cr_bd_design_1 { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins top_0/s_axi_control]
  ...
  connect_bd_intf_net -intf_net top_0_m_axi_gmem0 [get_bd_intf_pins smartconnect_1/S00_AXI] [get_bd_intf_pins top_0/m_axi_gmem0]
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/full_proj.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/full_proj.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/full_proj.srcs/utils_1/imports/impl_1" -objects $obj
