...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRF_APB_DP_VIDEO_REF_CTRL_DIVISOR0                      0x6
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFD1A0070, 0x013F3F07U ,0x01010600U)
    */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070064, 0x0FFF83FFU ,0x0008804AU)
    */
	PSU_Mask_Write(DDRC_RFSHTMG_OFFSET, 0x0FFF83FFU, 0x0008804AU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Refresh Period
    *  PSU_DDR_PHY_PGCR2_TREFPRD                                   0xc18

    * PHY General Configuration Register 2
    * (OFFSET, MASK, VALUE)      (0XFD080018, 0xFFFFFFFFU ,0x00F00C18U)
    */
	PSU_Mask_Write(DDR_PHY_PGCR2_OFFSET, 0xFFFFFFFFU, 0x00F00C18U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080110, 0xFFFFFFFFU ,0x06180D08U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR0_OFFSET, 0xFFFFFFFFU, 0x06180D08U);
/*##################################################################### */
